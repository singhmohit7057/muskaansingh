      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-6 md:gap-10 mb-8 md:mb-14">
          ...
          <div>
            ...
            <p className="text-[#6B7280] text-xs leading-relaxed mb-3 hidden md:block">
            ...
            <div className="mt-4">
              <p className="text-xs font-semibold text-[#6B7280] uppercase tracking-widest mb-2">Follow</p>
              <div className="flex flex-wrap gap-x-4 gap-y-1 md:flex-col md:gap-y-2">
                {igAccounts.map((acc) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1 text-xs text-[#6B7280] hover:text-[#6C63FF] transition-colors"
                  >
                    <AtSign size={10} />
          ...
          {/* NAV */}
          <div>
            <p className="text-xs font-semibold text-[#6B7280] uppercase tracking-widest mb-3">Navigation</p>
            <ul className="grid grid-cols-2 md:grid-cols-1 gap-y-2 gap-x-4">
              {navLinks.map((l) => (
                <li key={l.label}>
                  <Link to={l.href} className="text-sm text-[#6B7280] hover:text-[#6C63FF] transition-colors font-medium">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          {/* LEGAL */}
          <div>
            <p className="text-xs font-semibold text-[#6B7280] uppercase tracking-widest mb-3">Legal</p>
          ...
          {/* PLATFORMS */}
          <div>
            <p className="text-xs font-semibold text-[#6B7280] uppercase tracking-widest mb-3">Available On</p>
            <div className="grid grid-cols-2 md:grid-cols-1 gap-y-2 gap-x-4">
              {platforms.map((p) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm text-[#6B7280] hover:text-[#6C63FF] transition-colors group"
                >
                  <p.icon size={13} className="text-[#A0AEC0] group-hover:text-[#6C63FF] transition-colors" />
        ...
        >
          <p className="text-xs text-[#6B7280]">© 2026 Muskaan Singh. All rights reserved.</p>
          <p className="text-xs font-semibold text-[#6B7280]">Made with ❤️ by <a href="https://www.tmmt.in" target="_blank" rel="noopener noreferrer" className="text-[#6C63FF] hover:text-[#8B84FF] transition-colors">TMMT</a></p>
        </div>
